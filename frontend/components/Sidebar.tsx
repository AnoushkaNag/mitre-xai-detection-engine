...
const navItems = [
  ...
  { icon: Shield, label: 'Threats', href: '#' },
      ...
      <nav className="flex-1 p-4 space-y-2">
        {navItems.map((item, i) => (
          <motion.a
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-text/80 hover:text-white hover:bg-dark-surface-alt transition-colors cursor-pointer group"
          >
